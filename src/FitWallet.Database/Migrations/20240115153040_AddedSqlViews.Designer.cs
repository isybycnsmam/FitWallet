...
namespace FitWallet.Database.Migrations
{
    ...
    [Migration("20240115153040_AddedSqlViews")]
    partial class AddedSqlViews
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitWallet.Core.Models.Category", b =>
                {
                    ...
                    b.HasIndex("UserId", "DisplayColor")
                        .IsUnique();
            ...
            modelBuilder.Entity("FitWallet.Core.Models.Views.WalletCategorySpending", b =>
                {
                    b.Property<int?>("CategoryDisplayColor")
                        .HasColumnType("integer");
                    ...
                    b.ToView("wallets_category_spendings", (string)null);
                });
